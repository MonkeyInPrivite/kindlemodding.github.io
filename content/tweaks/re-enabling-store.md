...
> [!WARNING]
> Ensure you've [disabled OTA Updates](../jailbreaking/post-jailbreak/disable-ota) before re-enabling the store.<br/><br/>This is <b>WinterBreak-Only</b>, and it does not apply to AdBreak.
...
<script>new Guide("guide", "../../../tweaks/", "Installing Apps");</script>
